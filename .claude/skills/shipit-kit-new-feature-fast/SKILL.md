...
.claude/skills/shipit-kit-new-feature/scripts/init-feature.sh "$NEXT_NUM" "$FEATURE_NAME"
```
...
status:
  ...
  lastUpdatedBy: 'shipit-kit:new-feature-fast'
...
checkpoints:
  - phase: 'feature-created'
    ...
    completedBy: 'shipit-kit:new-feature-fast'
...
> Continue to `/shipit-kit:implement` to start autonomous implementation?

- If **yes**: invoke `/shipit-kit:implement`
...
- Run implementation (that's `/shipit-kit:implement`)
...
This skill reuses assets from `shipit-kit:new-feature`:

- **Init script**: `.claude/skills/shipit-kit-new-feature/scripts/init-feature.sh`
- **Templates**: `.claude/skills/shipit-kit-new-feature/templates/`
