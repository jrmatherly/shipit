...
# Run init-feature.sh (reuses shipit-kit:new-feature templates)
...
**CRITICAL: Do NOT start implementation. Do NOT run `/shipit-kit:research`, `/shipit-kit:plan`, or `/shipit-kit:implement`.**
...
A new editor window should be opening. Once it's loaded, open the AI agent panel and continue with `/shipit-kit:research`.
...
3. Open the AI agent panel and continue with `/shipit-kit:research`
