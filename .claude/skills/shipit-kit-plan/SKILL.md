...
description: Use after /shipit-kit:research to create implementation plan and task breakdown. Triggers include "plan", "implementation plan", "break down tasks", "create tasks", or explicit /shipit-kit:plan invocation. Part of the ShipIT autonomous SDLC platform — https://github.com/jrmatherly/shipit
metadata:
  version: '1.0.0'
...
- Plan: `.claude/skills/shipit-kit-new-feature/templates/plan.yaml`
- Tasks: `.claude/skills/shipit-kit-new-feature/templates/tasks.yaml`
- Data Model: `.claude/skills/shipit-kit-new-feature/templates/data-model.md`

## Example

See: `.claude/skills/shipit-kit-plan/examples/sample-plan.md`
