---
name: shipit-kit:status
description: Quick feature status and "what to do next" guide. Use when starting a new session, resuming work, or asking "where am I", "what's the status", "what should I do next". Gives a zero-to-hero walkthrough of the current feature branch. Part of the ShipIT autonomous SDLC platform — https://github.com/jrmatherly/shipit
metadata:
  version: '1.0.0'
...
1. **Build:** `pnpm build`
2. **CLI:** `shipit-ai settings model` → pick a model
3. **CLI:** `shipit-ai feat new --model claude-opus-4-6 "test feature"`
