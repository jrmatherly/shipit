...
```bash
.claude/skills/shipit-kit-new-feature/scripts/init-feature.sh <NNN> <feature-name>
```
...
> Next: `/shipit-kit:research` to analyze technical approach.

## Open Questions Policy

**CRITICAL:** Open questions in `spec.yaml` (the `openQuestions` array) MUST be resolved before `/shipit-kit:research`.
...
Templates are in: `.claude/skills/shipit-kit-new-feature/templates/`
...
All shipit-kit skills update `feature.yaml` as work progresses.
...
See: `.claude/skills/shipit-kit-new-feature/examples/001-sample-feature/`
