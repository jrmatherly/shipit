...
description: Use after /shipit-kit:new-feature to analyze technical approach, evaluate libraries, document decisions. Triggers include "research", "technical analysis", "evaluate options", "which library", or explicit /shipit-kit:research invocation. Part of the ShipIT autonomous SDLC platform — https://github.com/jrmatherly/shipit
metadata:
  version: '1.0.0'
...
status:
  ...
  lastUpdatedBy: 'shipit-kit:research'
...
> Next: `/shipit-kit:plan` to create implementation plan.
...
YAML template (source of truth): `.claude/skills/shipit-kit-new-feature/templates/research.yaml`

## Example

See: `.claude/skills/shipit-kit-research/examples/sample-research.md`
