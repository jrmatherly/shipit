        ...
        rejectionFeedback: [
          {
            ...
            phase: 'requirements',
            attachments: ['/home/user/.shipit-ai/attachments/pending-abc/screenshot.png'],
          },
        ],
      });
    ...
    it('displays all rejection feedback entries even when more feedback than run:rejected events', () => {
      ...
      const feedback: RejectionFeedbackData[] = [
        ...
        },
        {
          iteration: 4,
          message:
            "I've test and created a feature but the screenshots seems to be broken https://github.com/jrmatherly/shipit/pull/258 fix",
          phase: 'merge',
        },
      ];
