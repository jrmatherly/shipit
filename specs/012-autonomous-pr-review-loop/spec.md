...
Today, `/shipit-kit:commit-pr` creates a PR, watches CI until green, and stops.
...
| -------------------------------------------- | ------ | ------------------------------------------------------------ |
| `.claude/skills/shipit-kit:commit-pr/SKILL.md` | High   | Core skill file being extended with the review loop workflow |
