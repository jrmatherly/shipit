...
- [ ] vaul is added as a dependency to @shipit-ai/web package.json
...
| `package.json` (@shipit-ai/web)                                     | Low    | Must add `vaul` as a dependency.                                                                                                         |

## Dependencies

- **vaul** (npm package): Headless drawer component for React. Required by shadcn/ui Drawer. Not yet installed — must be added to @shipit-ai/web.
