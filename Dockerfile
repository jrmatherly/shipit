# =============================================================================
# Shipit AI CLI - Multi-stage Docker Build
# =============================================================================
# Optimized for caching, speed, and minimal image size.
#
# Usage:
#   docker build -t shipit-ai-cli .
#   docker run shipit-ai-cli --version
#
# =============================================================================
...
RUN addgroup --system --gid 1001 nodejs \
  && adduser --system --uid 1001 shipitai
...
# CLI entrypoint - allows: docker run ghcr.io/jrmatherly/shipit --version
