...
const allStatesData: FeatureNodeData[] = [
  ...
  },
  {
    ...
    worktreePath: '/home/user/.shipit-ai/repos/abc123/wt/feat-api-rate-limiting',
    hasAgentRun: true,
    hasPlan: true,
  },
  {
    ...
    worktreePath: '/home/user/.shipit-ai/repos/abc123/wt/feat-data-pipeline',
    hasAgentRun: true,
    hasPlan: true,
  ...
  },
  {
    ...
    worktreePath: '/home/user/.shipit-ai/repos/abc123/wt/feat-merge-review',
    hasAgentRun: true,
    hasPlan: true,
    pr: {
  ...
  },
  {
    ...
    worktreePath: '/home/user/.shipit-ai/repos/abc123/wt/feat-payment-gateway',
    fastMode: true,
    hasAgentRun: true,
    hasPlan: true,
    pr: {
  ...
  },
  {
    ...
    worktreePath: '/home/user/.shipit-ai/repos/abc123/wt/feat-search-index',
    hasAgentRun: true,
    hasPlan: true,
  },
  {
    ...
    agentType: 'copilot-cli' as AgentTypeValue,
    modelId: 'claude-sonnet-4-6',
    repositoryPath: '/home/user/my-repo',
    repositoryName: 'my-repo',
  ...
  },
  {
    ...
    worktreePath: '/home/user/.shipit-ai/repos/abc123/wt/feat-legacy-api-cleanup',
    agentType: 'claude-code' as AgentTypeValue,
    hasAgentRun: true,
  },
  {
...
const allAgentTypesData: FeatureNodeData[] = [
  ...
  },
  {
    ...
    state: 'running',
    progress: 50,
    agentType: 'rovo-dev' as AgentTypeValue,
    modelId: 'auto',
    repositoryPath: '/home/user/my-repo',
