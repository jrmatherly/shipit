      ...
      evidence: [
        {
          ...
          relativePath: '.shipit-ai/evidence/homepage-banner.png',
          taskRef: 'task-1',
        },
        {
          type: 'TestOutput',
          ...
          relativePath: '.shipit-ai/evidence/unit-test-results.txt',
          taskRef: 'task-2',
        },
        {
          type: 'Video',
          ...
          relativePath: '.shipit-ai/evidence/login-flow.mp4',
        },
        {
          type: 'TerminalRecording',
          capturedAt: '2026-03-09T12:03:00Z',
          description: 'CLI auth command output',
          relativePath: '.shipit-ai/evidence/cli-auth.txt',
          taskRef: 'task-3',
        },
      ],
    },
      ...
      evidence: [
        {
          ...
          relativePath: '.shipit-ai/evidence/final-state.png',
        },
        {
          type: 'Video',
          capturedAt: '2026-03-09T12:02:00Z',
